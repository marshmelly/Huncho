...
const about = () => {
  return (
    <div>
      <div className="pip">
        <h1 className='text-white'>About Huncho</h1>

        <h2 className=" text-dark">
          Huncho was a determined Barber when he was young, and loved to do
          ...
          and it is a success. Thank you Huncho for enabling people to look at
          their best.
        </h2>
